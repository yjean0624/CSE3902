...
namespace Project.GameObjects
{
    public class StarMario : GameObject, IMario
    {
        ...
        public StarMario(Physics physics, Mario baseMario) : base(new Vector2(physics.xPosition,physics.yPosition))
        {
            ...
            this.sprite = SpriteMachine.Instance.CreateSprite(SpriteMachine.SpriteTag.OneHumpCloud);
            SoundEffectManager.Instance.PlaySoundEffect(SoundEffectManager.SoundEffectTag.StarMario);
            SoundEffectManager.Instance.PauseBackgroundMusic();
        }
        public override void Update(GameTime gameTime)
        {
            baseMario.Update(gameTime);
            ...
            if(millisecondsLeft <= 0.0f)
            {
                ...
                SoundEffectManager.Instance.StopSoundEffect(SoundEffectManager.SoundEffectTag.StarMario);
        ...
        public void Kill()
        {
            GameManager.Instance.Replace(this, new DeadMario(Location(), baseMario));
        }
        public override int GetBottomSide()
        {
            return baseMario.GetBottomSide();
        }
        public override int GetTopSide()
        {
            return baseMario.GetTopSide();
        }
        public override int GetLeftSide()
        {
            return baseMario.GetLeftSide();
        }
        public override int GetRightSide()
        {
            return baseMario.GetRightSide();
        }
        public override int GetWidth()
        {
            return baseMario.GetWidth();
        }
        public override int GetHeight()
        {
            return baseMario.GetHeight();
        }
        public override Rectangle GetHitBox()
        {
            return baseMario.GetHitBox();
        }
