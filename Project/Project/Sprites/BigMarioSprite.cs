...
namespace Project.Sprites
{
     ...
     */
    public class BigMarioSprite : IMarioSprite
    {
        ...
        public BigMarioSprite(Texture2D texture)
        {
            Texture = texture;
            standingRightMap = Config.GetStandingRightMapForBigMarioSprite();
            runningRightMap = Config.GetRunningRightMapForBigMarioSprite();
            jumpingRightMap = Config.GetJumpingRightMapForBigMarioSprite();
            standingLeftMap = Config.GetStandingLeftMapForBigMarioSprite();
            runningLeftMap = Config.GetRunningLeftMapForBigMarioSprite();
            jumpingLeftMap = Config.GetJumpingLeftMapForBigMarioSprite();
            crouchingLeftMap = Config.GetCrouchingLeftMapForBigMarioSprite();
            crouchingRightMap = Config.GetCrouchingRightMapForBigMarioSprite();
