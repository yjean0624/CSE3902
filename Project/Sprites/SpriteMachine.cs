...
{ 
    public sealed class SpriteMachine
    {
        public enum SpriteTag
        {
            ...
            StairBlock,
            QuestionBlock,
            SmallPipe, MediumPipe, LargePipe, LeftFacingPipe, PipeFlagpole, PipeHalf,
            Flag,
            FlagPole,
        ...
        private SpriteMachine()
        {
            ...
            spriteDictionary.Add(SpriteTag.PipeFlagpole.ToString(), (null, null, 0.0f));
            spriteDictionary.Add(SpriteTag.PipeHalf.ToString(), (null, null, 0.0f));
            ...
            spriteDictionary.Add(SpriteTag.Castle.ToString(), (null, null, 0.0f));
            spriteDictionary.Add(SpriteTag.FireballExplode.ToString(), (null, null, 0.0f));

            //Mouse
            spriteDictionary.Add(SpriteTag.MouseCursor.ToString(), (null, null, 0.0f));
